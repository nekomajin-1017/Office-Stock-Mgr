...
- 確定済み販売伝票の納品書 PDF 出力
- 集計期間の総仕入数量・仕入総額・総販売数量・販売総額のサマリー表示
- 未販売商品、最新仕入単価、在庫不足商品、平均販売数量付きの商品別販売ランキングの表示
...
- 在庫とレポートには確定済み伝票のみを反映し、下書き伝票と取消済み伝票は集計対象外とします。商品別の一覧とランキングには有効商品のみを表示します。
- レポートの仕入総額と販売総額は、対象期間の確定済み明細における税抜小計の合計です。
